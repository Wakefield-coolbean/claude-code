...
`rocket-roundtrip.html` is a single-file, cartoon 3D idle space game. Open it in any modern browser (it loads three.js from a CDN, so it needs an internet connection the first time).
